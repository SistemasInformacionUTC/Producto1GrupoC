...
insert into disk(id,name,capacidad,nucleos,computer_id) values (1,'hp',400,500,1);
insert into disk(id,name,capacidad,nucleos,computer_id) values (2,'samsung',700,800,2);
# --- !Downs
